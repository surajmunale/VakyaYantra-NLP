...
public class Swar { //Deerga, Guna, Vriddi Sandhis
    ...
    public void list() { // first column is swara, second column is vowel and third is swara.Eg 'ा','आ','ा'
        ...
        rules[12][0] = "\u093E"; rules[12][1] = "\u0907"; rules[12][2] = "\u0947"; rules[12][3]="Guna "; //आ','इ','�? '
        rules[13][0] = "\u093E"; rules[13][1] = "\u0908"; rules[13][2] = "\u0947"; rules[13][3]="Guna"; //आ','ई','�? '
        rules[14][0] = "";       rules[14][1] = "\u0908"; rules[14][2] = "\u0947"; rules[14][3]="Guna"; //('अ','ई','�?')
        rules[15][0] = "";       rules[15][1] = "\u0907"; rules[15][2] = "\u0947"; rules[15][3]="Guna"; //अ','इ','�? ');
        ...
        rules[20][0] = "";       rules[20][1] = "\u090b"; rules[20][2] = "\u0930\u094d"; rules[20][3]="Guna"; //('अ','ऋ','अर�?');
        rules[21][0] = "\u093E"; rules[21][1] = "\u090b"; rules[21][2] = "\u0930\u094d"; rules[21][3]="Guna"; // ('आ','ऋ','अर�?');
        
        rules[22][0] = "";       rules[22][1] = "\u090f"; rules[22][2] = "\u0948"; rules[22][3]="Vriddi"; //('अ','�?','�?');
        rules[23][0] = "";       rules[23][1] = "\u0910"; rules[23][2] = "\u0948"; rules[23][3]="Vriddi"; // ('अ','�?','�?');
        rules[24][0] = "\u093E"; rules[24][1] = "\u0910"; rules[24][2] = "\u0948"; rules[24][3]="Vriddi"; //('आ','�?','�?');
        rules[25][0] = "\u093E"; rules[25][1] = "\u090f"; rules[25][2] = "\u0948"; rules[25][3]="Vriddi"; // ('आ','�?','�?');
    ...
    String[] swaras1 ={"\u093E","\u0940","\u0942","\u0948","\u094c","\u0947","\u094b","\u0930\u094d","\u0932\u094d"}; //{"ा", "ी","ू","ै","ौ","े", "ो","र�?","ल�?"};
    String mainWord;
...
//        System.out.println(resu lt); //कवि ईशः");//भान�? उदयः
//    }
//}
