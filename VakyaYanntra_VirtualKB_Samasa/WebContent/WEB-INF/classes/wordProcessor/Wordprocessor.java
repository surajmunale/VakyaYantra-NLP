...
public class Wordprocessor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        samasaOutputLabel = new javax.swing.JLabel();
        jScrollPane6 = new javax.swing.JScrollPane();
        samasaOutputPane = new javax.swing.JTextPane();
        ...
        samasaMenu = new javax.swing.JMenu();

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        getContentPane().setLayout(null);

        jTextPane1.setFont(new java.awt.Font("xdvng", 0, 18));
        ...
        jScrollPane2.setBounds(620, 30, 550, 130);

        jTextPane3.setFont(new java.awt.Font("DejaVu Sans", 0, 18));
        jScrollPane3.setViewportView(jTextPane3);

        getContentPane().add(jScrollPane3);
        jScrollPane3.setBounds(620, 190, 550, 120);
        ...
        jLabel5.setBounds(620, 170, 200, 14);
        ...
        jScrollPane5.setBounds(620, 340, 550, 120);

        jLabel7.setText("Output of Vrutta");
        getContentPane().add(jLabel7);
        jLabel7.setBounds(620, 320, 140, 14);

        samasaOutputLabel.setText("Output of Samasa");
        getContentPane().add(samasaOutputLabel);
        samasaOutputLabel.setBounds(620, 490, 140, 14);

        jScrollPane6.setViewportView(samasaOutputPane);

        getContentPane().add(jScrollPane6);
        jScrollPane6.setBounds(620, 520, 550, 120);
        ...
        samasaMenu.setText("Samasa");
        samasaMenu.addMenuListener(new javax.swing.event.MenuListener() {
            public void menuCanceled(javax.swing.event.MenuEvent evt) {
            }
            public void menuDeselected(javax.swing.event.MenuEvent evt) {
            }
            public void menuSelected(javax.swing.event.MenuEvent evt) {
                samasaMenuSelected(evt);
            }
        });
        jMenuBar1.add(samasaMenu);
...
try {
    ...
    private void samasaMenuSelected(javax.swing.event.MenuEvent evt) {//GEN-FIRST:event_samasaMenuSelected
        // TODO add your handling code here:
        ...
        if(!jTextPane1.getSelectedText().trim().equals("")){
            ...
            inputtoSamas=jTextPane1.getSelectedText().trim();
                        System.out.println("inputtosamas"+inputtoSamas);

            // AvyayiBhava ab=new AvyayiBhava();
            Dwanda_Formatted d=new Dwanda_Formatted();
          //Dwanda_Old d=new Dwanda_Old();
            String vigraha= d.getVigraha(inputtoSamas);
             long stopTime = System.currentTimeMillis();
      long elapsedTime = stopTime - startTime;
      System.out.println(elapsedTime);
            if(vigraha!="")
            samasaOutputPane.setText(vigraha);
            else
                 JOptionPane.showMessageDialog(null,"Sorry, couldnt get the individual words");
        }
        else{
            JOptionPane.showMessageDialog(null,"Enter a proper text");
           
        }
    }//GEN-LAST:event_samasaMenuSelected
    ...
    private javax.swing.JMenu samasaMenu;
    private javax.swing.JLabel samasaOutputLabel;
    private javax.swing.JTextPane samasaOutputPane;
